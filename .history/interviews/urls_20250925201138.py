...
urlpatterns = [
    ...
    path("recruiter/review/", views.recruiter_review_attempts, name="recruiter_review_attempts"),
    path("candidate/attempts/<int:attempt_id>/reset/", views.reset_attempt, name="reset_attempt"),

    path("candidate/attempts/<int:attempt_id>/autosave/", views.autosave_attempt, name="autosave_attempt"),
    path("candidate/attempts/<int:attempt_id>/events/", views.attempt_events, name="attempt_events"),
# add near other url patterns in interviews/urls.py
path("recruiter/page/create/", views.recruiter_create_interview_page, name="recruiter_create_interview_page"),
path("recruiter/page/invite/", views.recruiter_invite_candidate_page, name="recruiter_invite_candidate_page"),
