...
class InterviewQuestion(models.Model):
    ...
    answer = models.CharField(max_length=50, null=True, blank=True)  # correct option or sample answer
    ...
    # Optional: hash to detect duplicates quickly
    text_hash = models.CharField(max_length=64, null=True, blank=True, db_index=True)

    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    # created_by (optional) if you want to know who confirmed/published
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.SET_NULL, related_name='created_questions')

    def save(self, *args, **kwargs):
        # maintain text_hash for dedupe checks
