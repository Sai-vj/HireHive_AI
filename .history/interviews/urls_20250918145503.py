...
path('recruiter/<int:pk>/invite/', views.recruiter_invite_candidate, name='recruiter_invite_candidate'),
...
# optional fragment route for HTMX
path('invites/<int:invite_id>/row/', views.invite_row_fragment, name='invite_row_fragment'),

path('recruiter/<int:pk>/invite/modal/', views.interview_invite_modal, name='interview_invite_modal'),
path('candidate/<int:pk>/start/frontend/', views.start_interview_attempt_frontend, name='start_interview_attempt_frontend'),
