...
def recruiter_create_list_interviews(request):
    ...
    # POST -> use create/update serializer
    from .serializers import InterviewCreateUpdateSerializer
    serializer = InterviewCreateUpdateSerializer(data=request.data)
    if serializer.is_valid():
        # IMPORTANT: set created_by field manually
        serializer.save(created_by=request.user)
        return Response(InterviewSerializer(serializer.instance).data, status=201)
