...
async function respondToInvite(inviteId, answer) {
  // answer: "accept" or "decline"
  const token = localStorage.getItem('candidate_token') || ''; // or cookie/session
  const res = await fetch(`/api/interviews/candidate/invites/${inviteId}/respond/`, {
    method: 'POST',
