...
const FRONTEND_INTERVIEW_PAGE = (id, inviteId) => `/interviews/templates/candidate_interview.html?interview=${encodeURIComponent(id)}&invite=${encodeURIComponent(inviteId)}`;
