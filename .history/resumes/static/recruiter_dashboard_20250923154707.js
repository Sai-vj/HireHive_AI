...
(function() {
  ...
  parent.addEventListener('click', (ev) => {
    ...
    // ✅ Redirect to recruiter review page
    window.location.href = `/interviews/recruiter/review/?interview=${encodeURIComponent(interviewId)}`;
    // or if your review page is mounted at root without /interviews/:
    // window.location.href = `/recruiter/review/?interview=${encodeURIComponent(interviewId)}`;
  });
})();
