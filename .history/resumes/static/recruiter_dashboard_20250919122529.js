...
// use in your dashboard JS
const TOKEN_KEY = 'recruiter_token_v1';
function savedToken(){ return localStorage.getItem(TOKEN_KEY) || ''; }
function authHeadersJSON(){ const t = savedToken(); return Object.assign({ 'Content-Type':'application/json' }, t ? { 'Authorization': `Bearer ${t}` } : {}); }
async function apiFetchSimple(url, opts={}) {
  opts.headers = Object.assign({}, opts.headers||{}, authHeadersJSON());
