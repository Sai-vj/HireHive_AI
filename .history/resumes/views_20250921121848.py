...
def shortlist_resume(request):
    ...
    DELETE: remove shortlist by id (accepts JSON body or query param 'id')
    """
    try:
            ...
            if not created:
                if resend:
                    ...
                    if candidate_email:
                        ...
                        # Try Celery, fallback to sync send
                        try:
                            ...
                            # fallback: attempt sync email send and log
                            try:
        ...
        # DELETE -> remove by id (support body or ?id=)
