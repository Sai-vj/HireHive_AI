...
@csrf_exempt   # optional if POST CSRF issues, but safer with CSRF token
def logout_view(request):
    logout(request)   # clears the session server-side
    response = redirect('home')
    response.delete_cookie('sessionid')   # force clear sessionid cookie
    return response
