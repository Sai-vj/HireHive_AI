...
path('recruiter/<int:pk>/invite/', views.recruiter_invite_candidate),
...
#pages
path('recruiter/<int:pk>/questions/page/', views.recruiter_questions_page, name='recruiter_questions_page'),
