...
urlpatterns = [
    ...
    # ---------------- Optional frontend/HTMX helpers ----------------
    ...
    path("frontend/start/<int:pk>/", views.start_interview_attempt_frontend, name="start_interview_attempt_frontend"),
    path("candidate/page/<int:pk>/", views.candidate_interview_page, name="candidate_interview_page"),
]
