...
const REGISTER_URL = 'accounts//register/'; // your Django view
const LOGIN_PAGE = 'accounts/login/';      // url to redirect after success
...
async function doRegister(username, email, password, role='student') {
  ...
  if (!res.ok) {
    document.getElementById('msg').innerText = data.detail || "Register failed";
    return;
  }
