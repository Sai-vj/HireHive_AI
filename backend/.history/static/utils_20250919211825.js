...
// utils_module.js — ES module adaptor that proxies window globals to named exports
export const saveTokens = (...args) => window.saveTokens?.(...args);
export const clearTokens = (...args) => window.clearTokens?.(...args);
export const getAccessToken = (...args) => window.getAccessToken?.(...args);
export const getRefreshToken = (...args) => window.getRefreshToken?.(...args);
export const isTokenExpired = (...args) => window.isTokenExpired?.(...args);
export const refreshAccessToken = (...args) => window.refreshAccessToken?.(...args);
export const fetchWithAuth = (...args) => window.fetchWithAuth?.(...args);
export const apiFetchAsJson = (...args) => window.apiFetchAsJson?.(...args);
