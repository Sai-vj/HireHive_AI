...
async function routeByRoleSmart(role) {
  ...
  const preferred = role === 'recruiter'
    ? ['/resumes/dashboard/recruiter/', '/resumes/recruiter_dashboard/', '/accounts/recruiter-dashboard/']
    : ['/resumes/dashboard/candidate/', '/resumes/candidate_dashboard/', '/accounts/candidate-dashboard/'];
