...
urlpatterns = [
    ...
    path('recruiter_dashboard/', lambda req: render(req, 'recruiter_dashboard.html'), name='recruiter-dashboard'),
    path('my-shortlists/', my_shortlists, name='my-shortlists'),
    path('candidate_dashboard/', lambda req: render(req, 'candidate_dashboard.html'), name='candidate-dashboard'),
