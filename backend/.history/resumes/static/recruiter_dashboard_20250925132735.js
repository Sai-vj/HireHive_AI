...
/**
 * Attach handlers to buttons in page.
 * Supported button attributes:
 *  - For creating an interview then generating questions: data-job-pk="123" (optional data-questions-count, data-auto-publish)
 *  - For generating on an existing interview: data-interview-id="456" (optional data-questions-count, data-auto-publish)
 *  - For legacy classes: also honors .generate-quiz-btn and .generate-questions-btn if they have data-job-id or data-interview-id
 */
