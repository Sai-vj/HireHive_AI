...
// Auto cookie-auth integration (manual token UI removed)
// if using wrapper
import _apiFetch from './_apiFetch.js';
const res = await _apiFetch('/api/resumes/my-resumes/'); 
if (!res.ok) { /* handle 401 */ }
