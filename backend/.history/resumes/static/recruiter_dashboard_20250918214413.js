...
function showInviteModal({ jobId, candidateId = null, candidateName = null }) {
  ...
  inviteMessageInput.value = `Hi ${candidateName || ''}, you are invited for interview.`;
  inviteScheduledAtInput.value = '';
...
async function sendInvite() {
  ...
  const scheduled_at = inviteScheduledAtInput.value;
...
// optional: close modal if background clicked
inviteModal.addEventListener('click', (e) => {
  if (e.target === inviteModal) hideInviteModal();
});

// ============== END INVITE MODAL PATCH ==============